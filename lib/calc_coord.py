...
import math
import sys
sys.path.append('/home/exiot/ros/src/opust_ros/lib')
...
class azel_calc(object):
    ...
    def coordinate_calc(self, x_list, y_list, time_list, coord, off_az, off_el, hosei, lamda):
        if coord == "planet":
            planet_flag = True
            coord = "altaz"
        else:
